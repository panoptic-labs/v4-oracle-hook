...
/// @dev This adapter exposes the normal tickCumulative values from V3StyleOracleHook.
contract V3OracleAdapter {
    ...
    {
        (blockTimestamp, , tickCumulative, , initialized) = v3StyleOracle.observationsById(
            poolId,
            uint16(index)
        );
    ...
    {
        (tickCumulatives, ) = v3StyleOracle.observe(secondsAgos, poolId);
